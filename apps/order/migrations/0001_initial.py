# Generated by Django 2.1 on 2019-07-23 21:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_method', models.SmallIntegerField(choices=[(1, 'STANDARD'), (2, 'PRIORITY')], default=1, verbose_name='shipping_method')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0, max_digits=9, null=True, verbose_name='tax')),
                ('shipping_fee', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='shipping_fee')),
                ('pay_method', models.SmallIntegerField(choices=[(1, 'PAYPAL'), (2, 'CREDIT CARD')], default=1, verbose_name='pay_method')),
                ('order_status', models.SmallIntegerField(choices=[(1, 'NOT PAY'), (2, 'PAID,WAIT FOR SHIPPING'), (3, 'SHIPPING'), (4, 'SHIPPED'), (5, 'COMPLETED')], default=1, verbose_name='order_status')),
                ('trade_no', models.CharField(default='', max_length=128, verbose_name='trade_number')),
            ],
            options={
                'ordering': ('order_id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='order.Order', verbose_name='order_item')),
